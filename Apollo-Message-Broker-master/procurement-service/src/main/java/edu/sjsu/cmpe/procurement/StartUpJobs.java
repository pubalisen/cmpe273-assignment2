...
public class StartUpJobs extends Job{
	...
	public String consumer() throws JMSException{
		...
		Destination dest = new StompJmsDestination("/queue/73081.book.orders");//destination);

		MessageConsumer consumer = session.createConsumer(dest);
		//System.out.println(.toString());

		System.out.println("Waiting for messages from " + "/queue/73081.book.orders" + "...");
	...
	void doposting(String str)
	{
		try {
			...
			String input="{\"id\" :\"73081\",\"order_book_isbns\":["+str+"]}";
...

    	{
    		ArrayList<String> library=new ArrayList<String>();
    			...
    			WebResource webResource=client.resource("http://54.215.133.131:9000/orders/73081");
    	...
    	public void publisher(ArrayList<String>books) throws JMSException
    	{
    		...
    		String host = "54.215.133.131";
    		int port = Integer.parseInt("61613");
    		String destination_a = "/topic/73081.book.all";
    		String destination_b="/topic/73081.book.computer";
